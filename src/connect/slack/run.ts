/**
 * run.ts — the slack connection as ONE process: both halves of the wire, one restart
 * unit. `liquen start` spawns this for `connections.slack`; either half dying takes the
