...
Deno.test("liquen agent: one name, the identity flags in either spelling, nothing else", () => {
...
Deno.test("liquen agent: --principal repeats into the list, --no-mind makes a person alone", () => {
  assertEquals(
